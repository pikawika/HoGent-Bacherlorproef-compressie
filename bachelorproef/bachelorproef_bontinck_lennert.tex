...
\makeglossaries
\input{termen-declaration}


%mooie style voor code etc
\usepackage{color}
\usepackage{listings}
\input{list-styles-declaration.tex}
...
%caption duidelijker zichtbaar
\definecolor{ocre}{RGB}{243,102,25}
\usepackage{caption}
\usepackage[font={color=ocre,scriptsize},labelfont={it}]{caption}
...
%deel 2
\input{compressietool}
%deel 3
\input{afbeeldingscompressie}
\input{videocompressie}
%deel 4
\input{kwaliteit}
\input{onderzoek}
%deel 5
