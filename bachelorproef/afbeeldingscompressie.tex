...
\begin{itemize}
	...
	\item De  \gls{decoder} kan progressief de afbeelding inladen, startend met een weergave tegen lage resolutie tot deze uiteindelijk volledig is ingeladen. Dit is vooral interessant voor bestanden met enorm grote bestandsgroottes zoals in de medische sector.
	...
	\item Kan progressief ingeladen en 
...
\begin{itemize}
	...
	\item De \gls{webp} \gls{decoder} kan reeds een portie van de afbeelding weergeven zelfs als deze nog niet volledig gedownload is.
