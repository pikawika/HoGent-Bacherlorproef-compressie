...
De \gls{lossy} variant van \gls{webp} is een \gls{afbeeldingsformaat} dat zoals vele nieuwe generatie \glspl{afbeeldingsformaat} ontstaan is uit een \gls{intra-frame} \gls{compressie-algoritme} voor \gls{videocompressie}in dit geval VP8, een \gls{compressie-algoritme} dat in 2008 door Google ontwikkeld is. Het maakt is gebaseerd op het block prediction \gls{compressie-algoritme}.
